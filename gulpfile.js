var gulp          = require('gulp'),
    ...
    sourcePaths = {
        ...
        js: [
            ...
            'src/js/chapterone.js',
            'src/js/chapters.js',
            'src/js/chaptertree.js',
            'src/js/coordinates.js',
            'src/js/elevatorbiome.js',
            'src/js/engineer.js',
            'src/js/entities.js',
            'src/js/game.js',
            'src/js/maxheightratio.js',
            'src/js/maxwidthratio.js',
            'src/js/maxsizeratio.js',
            'src/js/node.js',
            'src/js/player.js',
            'src/js/room.js',
            'src/js/roomdefinition.js',
            'src/js/rooms.js',
            'src/js/roomshape.js',
            'src/js/roomsdefinitions.js',
            'src/js/rootnode.js',
            'src/js/scannerbiome.js',
            'src/js/scene.js',
            'src/js/size.js',
